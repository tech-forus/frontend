...
const SystemStatusLink: React.FC = () => (
        ...
        >
          ...
          <motion.div className="col-span-1" variants={itemVariants}>
            ...
            <div className="space-y-3">
              ...
              <ExternalLink href="https://peaceful-halva-d8c713.netlify.app">
                Transporter Login
              </ExternalLink>
              <ExternalLink href="https://docs.google.com/forms/d/e/1FAIpQLSe7UpRbS03kxdU6UUBOWU0OJFlmEtqaDXqe6XFUiGqaNlZETw/viewform?usp=header">
                Feedback
              </ExternalLink>
            </div>
          </motion.div>
